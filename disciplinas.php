...
<head>
    ...
    <script>
        ...
        function FillReglamento(sport) {
                $("#athletesTable tr").remove();
                $("#placeholderText").remove();

                var xmlhttp = new XMLHttpRequest();
                console.log("ID de Disciplina seleccionado: " + sport);
                xmlhttp.open("POST", "scripts/dataMgmt.php?q=FillReglamento&id=" + sport, true);
                console.log("Estado del XmlHttpRequest: " + xmlhttp.readyState);

                 xmlhttp.onreadystatechange = function() {
                    if(xmlhttp.readyState == 4 && xmlhttp.status == 200) {
                        console.log("Estado del XmlHttpRequest: " + xmlhttp.readyState);
                        document.getElementById('disciplinaTable').innerHTML = xmlhttp.responseText;
                    }
                }
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="disciplinas.php">Deportes<span style="font-size:16px;" class="pull-right hidden-xs showopacit"></span></a></li>
    ...
    <div class="todo">
       <div class="col-md-4 col-custom-list">
            <div class="form-group">
                ...
                <select name="sportName" id="selectedSport" class="form-control">
                    <?php
            ...
            <button onclick="FillReglamento(document.getElementById('selectedSport').value)" type="button" class="btn btn-default form-control">Cargar Datos&nbsp<span class="glyphicon glyphicon-chevron-right"></span></button>
        </div>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped" style="border-collapse: collapse;"  width="100%">
                <thead>
                    ...
                    <th width="20%" style="text-align:center">Reglas</th>
                    <th width="20%" style="text-align:center">Historia</th>
                    
                </thead>
                <tbody id="disciplinaTable"></tbody>
            </table>

            <p id="placeholderText" align="center"><i>Ajuste los parámetros a la izquierda y presione "CargarDatos"</i></p>
        </div>
    </div>
