...
<html lang="es">
    <head>
        ...
        <!--Scripts para llenar los dropdowns-->

        <!--Llenar los países cuando se cambia la región-->
        <script type="text/javascript">
            function fillCountries(str) {

                var xmlhttp = new XMLHttpRequest();
                console.log("ID de región seleccionada: " + str);
                xmlhttp.open("POST", "scripts/fillCountries.php?regionid=" + str, true);
        ...
        <!--Llenar los deportes cuando se cambia el país-->
        <script type="text/javascript">
            function fillSports(str) {

                var xmlhttp = new XMLHttpRequest();
                console.log("ID de país seleccionado: " + str);
                xmlhttp.open("POST", "scripts/fillSports.php?countryid=" + str, true);
                console.log("Estado del XmlHttpRequest: " + xmlhttp.readyState);
                        ...
                        <ul class="nav navbar-nav navbar-left">
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="#" id="dropdown-deportes">Deportes</a></li>
                                    <li><a href="#" id="dropdown-paises">Países</a></li>
            ...
            <div class="container-fluid">
                ...
                <div class="col-md-12">
                    <ul class="nav nav-pills nav-stacked col-md-3">
                        <li class="active"><a data-toggle="pill" href="#regions">Regiones</a></li>
                        <li><a data-toggle="pill" href="#countries?q=hola">Países</a></li>
                        <li><a data-toggle="pill" href="#sports">Deportes</a></li>
                    </ul>
                    <iframe name="content" class="col-md-9" src="athlete-regions.php" style="border: 0px none transparent; overflow: hidden; padding: 0px; width: 70%;" scrolling="no">
