        ...
        interval: 500 //changes the speed
         ...
         function fillCategories(id) {
            ...
            function fillAthlete(tourny, category) {
                ...
                xmlhttp.open("POST", "scripts/dataMgmt.php?q=fillHistoricAthletes&tid=" + tourny +"&cid=" + category, true);
                console.log("Estado del XmlHttpRequest: " + xmlhttp.readyState);
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                <ul class="nav navbar-nav">
                   <li><span style="font-size:16px;" class="pull-right hidden-xs showopacity"></span><a href="index.php">Home</a></li>
                    ...
                    <li class="active" ><a href="historicos.php">Historicos por Deportes<span style="font-size:16px;" class="pull-right hidden-xs showopacity"></span></a></li>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped" style="border-collapse: collapse;"  width="100%">
                <thead>
                    ...
                    <th width="18%" style="text-align:center">Nombre</th>
                    <th width="18%" style="text-align:center">Apellido</th>
                    <th width="20%" style="text-align:center">Tipo de Medalla</th>
                </thead>
                <tbody id="historicTable">
                </tbody>
            </table>

            <p id="placeholderText" align="center"><i>Ajuste los parámetros a la izquierda y presione "Ver atletas"</i></p>
        </div>
    </div>
