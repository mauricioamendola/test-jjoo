...
<head>
    ...
    <script>
        ...
        interval: 500 //changes the speed
         ...
         function fillHistoricCommittes(tourny) {
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-sidebar-navbar-collapse-1">
                <ul class="nav navbar-nav">
                   ...
                   <li class="active"><a href="historicos_delegaciones.php">Historicos por Torneo<span style="font-size:16px;" class="pull-right hidden-xs showopacity"></span></a></li>
    ...
    <div class="todo">
        <div class="col-md-4 col-custom-list">
            ...
            <button onclick="fillHistoricCommittes(document.getElementById('selectedTourny').value)" type="button" class="btn btn-default form-control">Ver historico&nbsp<span class="glyphicon glyphicon-chevron-right"></span></button>
        </div>
        ...
        <div class="table-responsive">
            ...
            <table class="table table-striped" style="border-collapse: collapse;"  width="100%">
                <thead>
                    <th width="18%" style="text-align:center">Delegacion</th>
                    <th width="18%" style="text-align:center"> ORO </th>
                    <th width="18%" style="text-align:center"> PLATA </th>                
                    <th width="18%" style="text-align:center"> BRONCE </th>
                </thead>
                <tbody id="historicTable">
                </tbody>
            </table>

            <p id="placeholderText" align="center"><i>Ajuste los parámetros a la izquierda y presione "Ver Historicos"</i></p>
        </div>
    </div>
