...
<li><a href="phases.php">Gestion de Fases</a></li>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <form action="../scripts/fillData.php?q=updateRegion" method="post" enctype="multipart/form-data" role="form">
                        <div class="form-group">
                            <label for="regionName" class="form-label">Nuevo nombre:</label>
                            <input type="text" name="regionName" id="sportName">
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="regionId" value="<?php echo $_REQUEST['id']; ?>">
