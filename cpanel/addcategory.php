...
<li><a href="phases.php">Gestion de Fases</a></li>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h1 class="page-header">&nbsp&nbspAgregar categoría para <?php echo utf8_encode($_REQUEST['ename']) ?></h1>
                    <div class="col-md-4">
                        <form action="../scripts/fillSports.php?q=insertCategory" method="post" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="categoryDescription" id="categoryDescription" cols="20" rows="5"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="categoryGender" class="form-label">Género:</label>
                                <select class="form-control" name='categoryGender' id='categoryGender'>
                                    <option value="masculino">Masculino</option>
                                    <option value="femenino">Femenino</option>
                                </select>
                            </div>
                            <div class="form-group">
                                <input type="hidden" name="sportId" value="<?php echo $_REQUEST['sid']; ?>">
                                <input type="submit" value="Añadir categoría" name="submit">
                            </div>
                        </form>
                    </div>
                </div>
