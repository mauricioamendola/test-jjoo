...
<li><a href="phases.php">Gestion de Fases</a></li>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <form action="../scripts/updateSport.php" method="post" enctype="multipart/form-data" role="form">
                        <div class="form-group">
                            <label for="sportName" class="form-label">Nuevo nombre:</label>
                            <input type="text" name="sportName" id="sportName">
                        </div>
                        <div class="form-group">
                            <label for="sportDescription" class="form-label">Nueva descripción:</label>
                            <textarea name="sportDescription" id="sportDescription" cols="20" rows="5"></textarea>
                        </div>
                        <div class="form-group">
                            <input type="hidden" name="sportId" value="<?php echo $_REQUEST['id']; ?>">
                            <input type="submit" value="Añadir deporte" name="submit" class="btn btn-primary">
                        </div>
                    </form>
                </div>
            </div>
