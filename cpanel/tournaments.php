    ...
    <head>
        ...
        <script>
            ...
            function confirmDelete(id) {
                var x;
                if (confirm("¿Está seguro que desea eliminar el torneo seleccionado?") == true) {
                    location.href="../scripts/dataMgmt.php?q=deleteTourny&id=" + id;
                } else {
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <?php
                        if(isset($_REQUEST['q']) and $_REQUEST['q']=='add'){
                            echo "
                                    <div class='row'>
                                            <div class='alert alert-success' role='alert'>Información agregada correctamente&nbsp&nbsp&nbsp<span class='glyphicon glyphicon-ok'></span></div>
                                    </div>";
                        }
                        if(isset($_REQUEST['q']) and $_REQUEST['q']=='update'){
                            echo "
                                    <div class='row'>
                                            <div class='alert alert-success' role='alert'>Información actualizada correctamente&nbsp&nbsp&nbsp<span class='glyphicon glyphicon-ok'></span></div>
                                    </div>";
                        }
                    ...
                    ?>
                    <h1 style="display: inline; margin-right: 20px;">Torneos</h1>
                    <button class="btn btn-success btn-sm" style="display: inline; margin-bottom: 10px;" onclick="location.href='addtournament.php';"><span class="glyphicon glyphicon-plus"></span>&nbsp&nbsp&nbspAgregar</button>
                </div>
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    
                       
                        <br><br>
                        <table class='display' id="tournaments">
                            <thead>
                                <tr>
                                    <th>ID Torneo</th>
                            ...
                            <tbody id="tournaments-rows">
                                <?php
                                    include_once "../scripts/fillData.php";
                                    fillTournamentsTable();
                                ?>
                            </tbody>
                        </table>
