...
<html lang="es">
    <head>
        ...
        <?php echo "<title>Ver Detalle del Participante Nº".utf8_encode($_REQUEST['cid']).",".utf8_encode($_REQUEST['cname'])." ".utf8_encode($_REQUEST['csurname'])."</title>";?>
...
<li><a href="phases.php">Gestion de Fases</a></li>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <h1 class="page-header">Detalles del Participante</kbd></h1>
                        <form >
                            <?php
                                include_once "../scripts/fillCompetitor.php";
                                ShowCompetitor($_REQUEST['cid'],$_REQUEST['type']);
                            ?>
                        </form>
                </div>
                <div class="col-md-12">
