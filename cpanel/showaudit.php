...
<html lang="es">
    <head>
        ...
        <title>Ver Detalle de Auditor&iacute;a</title>
...
<li><a href="phases.php">Gestion de Fases</a></li>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <?php echo "<h1 class='page-header'>Detalles de la Auditoria Nº<kbd>".utf8_encode($_REQUEST['aid'])."</kbd></h1>"; ?>
                        <form >
                            <?php
                                include_once "../scripts/fillAudit.php";
                                ShowAudit($_REQUEST['aid']);
                            ?>
                        </form>
                </div>
                <div class="col-md-12">
