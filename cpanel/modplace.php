...
<li><a href="phases.php">Gestion de Fases</a></li>
                        ...
                        <li class="active"><a href="places.php">Lugares y edificios <span class="sr-only">(current)</a></li>
                    </ul>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <?php echo "<h1 class='page-header'>Modificando <kbd>".$_REQUEST['name']."</kbd></h1>"; ?>
                    <div class="col-md-4">
                        <form action="../scripts/dataMgmt.php?q=updatePlace" method="post" enctype="multipart/form-data" role="form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="submit" value="Aceptar cambios" name="submit" class="btn btn-success">
                            </div>
                        </form>
                    </div>
                    <div class="col-md-6">
