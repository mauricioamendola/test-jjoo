        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    ...
                    <h1 class="page-header" style="display: inline; margin-right: 20px;">&nbsp&nbspAgregar Fase</h1>
                </div>
                <div class="col-sm-4 col-sm-offset-3 col-md-4 col-md-offset-2 main">
                    <form action="../scripts/fillPhases.php?q=addPhase" method="post" enctype="multipart/form-data" role="form">
                        <div class="form-group">
                            <label for="PhaseName" class="form-label">Nombre de la Fase:</label>
                            <input type="text" class="form-control" name="PhaseName" id="PhaseName">
                        </div>
                        <br>
                        <div class="form-group">
                        ...
                        <div id='tipo' class='form-group'>
                            ...
                            <select name='tipo' id='tipo' class='form-control'>
                                <option selected value='grupo'>Grupo</option>
                        ...
                        <br><br><br>
                        <button type="submit" class="btn btn-success">Ingresar Fase</button>
                    </form>
                </div>
            </div>
        </div>
