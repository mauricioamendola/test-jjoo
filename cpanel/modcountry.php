...
<li><a href="phases.php">Gestion de Fases</a></li>
                ...
                <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
                    <?php echo "<h1 class='page-header'>Modificando <kbd>".utf8_encode($_REQUEST['name'])."</kbd></h1>"; ?>
                    <div class="col-md-4">
                        <form action="../scripts/fillCountries.php?q=updateCountry" method="post" enctype="multipart/form-data" role="form">
                            <div class="form-group">
                                <label for="countryName" class="form-label">Nuevo nombre:</label>
                                <input type="text" name="countryName" id="countryName" class="form-control">
                            </div>
                            <div class="form-group">
                                <label for="region" class="form-label">Nueva región:</label>
                                <?php include_once("../scripts/fillData.php"); fillRegions(); ?>
                            </div>
                            <div class="form-group">
                                <label for="countryIso" class="form-label">Nuevo código ISO:</label>
                                <input type="text" name="countryIso" id="countryIso" class="form-control">
                            </div>
                            <div class="form-group">
                                <input type="text" name="countryId" hidden="hidden" value="<?php echo $_REQUEST['id'];?>">
                                <input type="submit" value="Ingresar país" name="submit">
                            </div>
                        </form>
                    </div>
                </div>
